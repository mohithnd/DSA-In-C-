...
void dfs_connected_components(vector<vector<int>> adj_list)
{
...
void dfs(vector<vector<int>> adj_list, bool connected_components = false)
{
    if (connected_components)
    {
        dfs_connected_components(adj_list);
        return;
    }
    vector<int> ans;
    vector<bool> visited(adj_list.size(), false);
